PLUGIN ENVIAR EMAIL PARA SPIP 2

El plugin "Enviar email" para SPIP 2 crea un enlace que permite enviar la referencia del artículo o breve por email a una o varias direcciones.
...
- Descomprime el archivo "enviar_email_spip_2.zip".
...
Para otras modificaciones abre el archivo baliza_enviar_email.php y retoca lo que quieras. Por ejemplo, el '580' y el '500' son el ancho y el alto de la ventana que se abre.
