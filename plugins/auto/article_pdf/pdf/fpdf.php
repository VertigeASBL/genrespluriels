  ...
  //Put an image on the page
	if(!isset($this->images[$file]))
	{
		...
		elseif ($type=='png') 
		{
			...
			imagecopy($backgroundimage, $image, 0, 0, 0, 0, $im_X, $im_Y);
			ImagePNG($backgroundimage,"./IMG/tempo.png");
			ImageDestroy($image);
...
{
	require_once "gif.php";	// Classes GIF en pur PHP de Yamasoft (http://www.yamasoft.com/)
	...
	if ($this->compress) {
		...
		$parms='/DecodeParms <</Predictor 1 /Colors 1 /BitsPerComponent 8>>';
		return array(	'w'=>$w,			'h'=>$h,			'cs'=>$colspace,
						'bpc'=>8,			'f'=>'FlateDecode', 'parms'=>$parms,
